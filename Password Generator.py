...
length_of_password_requested=random.randint(length_of_password_entered-3, length_of_password_entered+3)
...
print("\n You might wish to change this algorithm to include the generation of the range based on user input, but presently I am using RANGE_MINIMUM as ENTERED_Value-3 and RANGE_MAXIMUM as ENTERED_Value+3")
